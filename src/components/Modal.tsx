...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-center items-center bg-black/50 backdrop-blur-sm">
      <div className={'pointer-events-auto absolute w-1/2 max-w-lg mx-4 h-3/4 z-10002 text-black bg-white rounded-2xl shadow-lg flex flex-col justify-between items-center'}>
