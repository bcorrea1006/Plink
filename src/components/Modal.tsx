...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex px-3 justify-center items-center bg-black/50 backdrop-blur-sm">
      <div className={`pointer-events-auto absolute max-w-lg w-3/4 mx-4 h-3/4 z-10002 text-black
